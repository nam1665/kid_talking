...
var launching_day = "pronuncation_trigger_for_launching";
        ...
        if (this.show) {
            return (
              <div className="col-md-7 text-center">
                  ...
                  <p className="mb-2">
                      <img hidden={this.state.hidepicture} src={this.state.image} alt="" style={{ width: 300 }} />
                  </p>
              </div>
            );
        }
